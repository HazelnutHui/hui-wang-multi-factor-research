...
_spec = _ilu.spec_from_file_location("low_vol_v2_config", _cfg_path)
...
def _make_engine_config():
    ...
    return {
        ...
        "LOW_VOL_WINDOW": cfg.LOW_VOL_WINDOW,
        "LOW_VOL_LOG_RETURN": cfg.LOW_VOL_LOG_RETURN,
        "LOW_VOL_USE_RESIDUAL": cfg.LOW_VOL_USE_RESIDUAL,
        "LOW_VOL_BENCH_SYMBOL": cfg.LOW_VOL_BENCH_SYMBOL,
        "LOW_VOL_DOWNSIDE_ONLY": cfg.LOW_VOL_DOWNSIDE_ONLY,

        "SIGNAL_ZSCORE": cfg.SIGNAL_ZSCORE,
        "SIGNAL_RANK": cfg.SIGNAL_RANK,
        "SIGNAL_RANK_PCT": cfg.SIGNAL_RANK_PCT,
        "SIGNAL_WINSOR_PCT_LOW": cfg.SIGNAL_WINSOR_PCT_LOW,
        "SIGNAL_WINSOR_PCT_HIGH": cfg.SIGNAL_WINSOR_PCT_HIGH,
        "SIGNAL_SMOOTH_WINDOW": cfg.SIGNAL_SMOOTH_WINDOW,
        "SIGNAL_SMOOTH_METHOD": cfg.SIGNAL_SMOOTH_METHOD,
...
def main():
    ...
    factor_weights = {"momentum": 0.0, "reversal": 0.0, "low_vol": 1.0, "pead": 0.0}
