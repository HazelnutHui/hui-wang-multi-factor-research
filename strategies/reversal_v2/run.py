...
_spec = _ilu.spec_from_file_location("reversal_v2_config", _cfg_path)
...
def _make_engine_config():
    ...
    return {
        ...
        'REVERSAL_VOL_LOOKBACK': cfg.REVERSAL_VOL_LOOKBACK,
        'REVERSAL_EARNINGS_FILTER_DAYS': cfg.REVERSAL_EARNINGS_FILTER_DAYS,
        'REVERSAL_MAX_GAP_PCT': getattr(cfg, 'REVERSAL_MAX_GAP_PCT', None),
        'REVERSAL_MIN_DOLLAR_VOL': getattr(cfg, 'REVERSAL_MIN_DOLLAR_VOL', None),
    }
...
def main():
    ...
    factor_weights = {'momentum': 0.0, 'reversal': 1.0, 'low_vol': 0.0, 'pead': 0.0}
