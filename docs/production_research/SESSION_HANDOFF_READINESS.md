...
Purpose:
- verify that a new session can follow `SESSION_CONTINUITY_PROTOCOL.md` end-to-end;
...
1. Parse Section 3 in `SESSION_CONTINUITY_PROTOCOL.md` and extract mandatory read sequence.
...
Run this checker before handoff-related commits and before opening a new session for continuation.
