...
- auto research orchestration:
  ...
  - scheduler mode now supports singleton lock, heartbeat, scheduler ledger, webhook/command alerts, alert dedupe window, and structured alert payloads (with recent failure summary)
