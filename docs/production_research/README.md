...
- `COMBO_RESEARCH_BASELINE_2026-03-11.md` (combo-layer locked protocol and promotion rules)
- `COMBO_PREREGISTERED_SET_2026-03-11.md` (cycle-1 combo candidate registry, 12 configs)
